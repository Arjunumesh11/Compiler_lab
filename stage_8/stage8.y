...
%token ALLOC  INTIALIZE RETURN MAIN READ BRKP NEW SELF CLASS ENDCLASS Extends WRITE TYPE ENDTYPE NULL0 POW VAR PLUS MINUS MUL DIV BEGIN0 END NUM EQUAL GRT LST GRE LSE NEQUAL EEQUAL IF THEN ENDIF ENDWHILE DO ELSE WHILE BREAK CONTINUE DECL ENDDECL INT STR

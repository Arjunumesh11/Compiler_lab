...
{
  "$end", "error", "$undefined", "VAR", "END", "$accept", "program", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 11 "test.y" /* yacc.c:1646  */
    {printf("var : %c",(yyvsp[-1].var_name));}
